...
class TempKeyring:
    ...
    def _patch_and_create_keychain(
        ...
        mock_supports_keyring_passphrase_patch = patch("tad.util.keychain.supports_keyring_passphrase")
        ...
        mock_supports_os_passphrase_storage_patch = patch("tad.util.keychain.supports_os_passphrase_storage")
