...
Write-Output "   ---"
Invoke-WebRequest -Uri "https://pypi.tad.net/simple/miniupnpc/miniupnpc-2.2.2-cp39-cp39-win_amd64.whl" -OutFile "miniupnpc-2.2.2-cp39-cp39-win_amd64.whl"
...
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.tad.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .
...
Write-Output "   ---"
Write-Output "Increase the stack for tad command for (tad plots create) tadpos limitations"
