...
from tad.server.server import NodeType, ssl_context_for_client
from tad.server.ssl_context import private_ssl_ca_paths
...
class RpcClient:
    """
    Client to Tad RPC, connects to a local service. Uses HTTP/JSON, and converts back from
