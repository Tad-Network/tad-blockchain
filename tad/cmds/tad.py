...
from tad.util.keychain import set_keys_root_path, supports_keyring_passphrase
from tad.util.ssl import check_ssl
...
@click.option(
    ...
    default=False,
    is_flag=True,
    hidden=True,  # --wait-for-unlock is only set when launched by tad start <service>
)
@click.pass_context
