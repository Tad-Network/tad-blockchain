...
from tad.consensus.coinbase import create_pool_coin, create_farmer_coin
from tad.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
...
There is also a provided NodeClient object which implements many of the methods from tad.rpc.full_node_rpc_client
